...
def main():
    ...
    for i in range (0, len(dictProsentase)-1):
        for j in range (len(dictProsentase)-1, i, -1):
            if dictProsentase[kodeproduk[j]] < dictProsentase[kodeproduk[j-1]]:
                dictProsentase[kodeproduk[j]], dictProsentase[kodeproduk[j-1]] = dictProsentase[kodeproduk[j-1]], dictProsentase[kodeproduk[j]]
